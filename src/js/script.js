...

{
  ...
  class Cart {
    ...
    getElements(element) {
      ...
      thisCart.dom.productList = element.querySelector(select.containerOf.cartSummary);
    ...
    update() {
      ...
      for (let priceValue of thisCart.dom.totalPrice) {
        priceValue.textContent = thisCart.totalPrice;
      }
    }
  }
